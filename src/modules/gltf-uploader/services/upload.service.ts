...
export class UploadService {
  ...
  async update(
    id: string,
    updateGltfUploadDto: UpdateGltfUploadDto
  ): Promise<UploadGltf> {
    ...
    existingUpload.filename = updateGltfUploadDto.filename
    existingUpload.path = updateGltfUploadDto.path
    existingUpload.mimetype = updateGltfUploadDto.mimetype
