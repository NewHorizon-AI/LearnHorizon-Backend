...
// Importacion de Dtos
import { CreateModelTransformationDto } from '../../../dtos/article-entry/model-transformation/create-model-transformation.dto'
import { UpdateModelTransformationDto } from '../../../dtos/article-entry/model-transformation/update-model-transformation.dto'
...
export class ModelTransformationService {
  ...
  async createBaseModelTransformation(
    createModelTransformationDto: CreateModelTransformationDto
  ): Promise<ModelTransformation> {
    try {
      const newModelTransformation = await this.modelTransformationModel.create(
      ...
      throw new BadRequestException(
        `Failed to create BaseModelTransformation: ${error.message}`
      )
    }
  }
